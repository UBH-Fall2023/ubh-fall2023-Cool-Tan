...
def init():
    ...
    click_meal_nutrition = driver.find_element(By.XPATH,
                                               '/html/body/div[1]/div[2]/form/div[2]/div[6]/section/div[3]/table/tbody/tr/td[2]/button')
    click_meal_nutrition.click()

    search_menu_table(driver, header_array, menu)
...
def search_menu_table(driver, header_array, menu):
